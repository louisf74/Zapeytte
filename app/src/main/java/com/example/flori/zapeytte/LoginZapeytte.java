 ...
 */
public class LoginZapeytte extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mConnexionAnonyme = (Button) findViewById(R.id.connexion_anonyme_button);
        mConnexionAnonyme.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                attemptLogin();
            }
    ...
    private void addPseudosToAutoComplete(List<String> pseudoAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LoginZapeytte.this,
